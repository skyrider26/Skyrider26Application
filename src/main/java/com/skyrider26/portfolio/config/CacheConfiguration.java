...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.skyrider26.portfolio.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.skyrider26.portfolio.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            cm.createCache(com.skyrider26.portfolio.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(com.skyrider26.portfolio.domain.Authority.class.getName(), jcacheConfiguration);
